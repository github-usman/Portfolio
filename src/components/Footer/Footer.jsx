...
const Footer = () => {
  ...
  return <Container id="footer">
    ...
    <Profile>
        ...
        <div className="links">
            ...
            <div>
                ...
                <Slide direction="left" triggerOnce="true"><a href="tel:+91">+9194...</a></Slide>
            </div>
            <div>
                <span><HiOutlineMailOpen/></span>
               <Slide direction="left" > <a href="mailto:usman.placement@gmail.com">usman.placement@gmail.com</a></Slide>
            </div>
        </div>
    ...
    <Form>
        ...
        <form action="mailto:usman.placement@gmail.com" method="post" enctype="text/plain">
            <div className="name">
                <span><CgProfile/></span>
